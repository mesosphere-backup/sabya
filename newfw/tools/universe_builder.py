...
EPILOGUE_STRING = "In addition, environment variables named 'NEWFW_SOME_PARAMETER' " \
                "will be inserted against the provided package newfw (with params of the " \
                " form '{{some-parameter}}')"
...
def main(argv):
    ...
    parser.add_argument('package_dir_path', type=str,
                        help='The local path where the package newfw is located')
