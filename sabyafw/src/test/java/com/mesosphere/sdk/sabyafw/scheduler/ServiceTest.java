package com.mesosphere.sdk.sabyafw.scheduler;
...
//        ticks.add(Send.offerBuilder("sabyafw").build());
  //      ticks.add(Expect.launchedTasks("sabyafw-0-node"));
   //     ticks.add(Send.taskStatus("sabyafw-0-node", Protos.TaskState.TASK_ERROR).build());
...
//        ticks.add(Send.offerBuilder("sabyafw").setPodIndexToReoffer(0).build());
//        ticks.add(Expect.launchedTasks("sabyafw-0-node"));
//        ticks.add(Send.taskStatus("sabyafw-0-node", Protos.TaskState.TASK_RUNNING).build());
